...
![HomePage](https://github.com/DercilioFontes/SpotBot4/blob/master/docs/login-signup-screen.png)

## User Action Flow

![Action GIF](https://github.com/DercilioFontes/SpotBot4/blob/master/docs/driven-demo.gif)
